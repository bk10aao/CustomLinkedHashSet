...
| Method                            | Custom Avg (ns) | JDK Avg (ns) | Overall Winner                 | Margin |
|:----------------------------------|:----------------|:-------------|:-------------------------------|:-------|
| `add(E)`                          | 920,394         | 982,142      | **CustomLinkedHashSet**        | 1.07x  |
| `addAll(Collection<? extends E>)` | 774,436         | 703,908      | **LinkedHashSet (JDK)**        | 1.10x  |
| `clear()`                         | 58,514          | 59,814       | Tie (Statistically Equivalent) | 1.02x  |
| `clone()`                         | 625,292         | 634,914      | Tie (Statistically Equivalent) | 1.02x  |
| `contains(Object)`                | 1,528           | 2,320        | **CustomLinkedHashSet**        | 1.52x  |
| `containsAll(Collection<?>)`      | 385,430         | 320,733      | **LinkedHashSet (JDK)**        | 1.20x  |
| `equals(Object)`                  | 883             | 1,011        | **CustomLinkedHashSet**        | 1.14x  |
| `hashCode()`                      | 65,536          | 43,978       | **LinkedHashSet (JDK)**        | 1.49x  |
| `isEmpty()`                       | 245             | 317          | **CustomLinkedHashSet**        | 1.30x  |
| `iterator()`                      | 196,114         | 162,694      | **LinkedHashSet (JDK)**        | 1.21x  |
| `remove(Object)`                  | 2,095           | 2,228        | **CustomLinkedHashSet**        | 1.06x  |
| `removeAll(Collection<?>)`        | 206,660,483     | 207,504,914  | Tie (Statistically Equivalent) | 1.00x  |
| `retainAll(Collection<?>)`        | 205,324,258     | 204,576,608  | Tie (Statistically Equivalent) | 1.00x  |
| `size()`                          | 192             | 178          | **LinkedHashSet (JDK)**        | 1.08x  |
| `spliterator()`                   | 298,469         | 338,072      | **CustomLinkedHashSet**        | 1.13x  |
| `toArray()`                       | 114,767         | 90,039       | **LinkedHashSet (JDK)**        | 1.27x  |
| `toArray(T[])`                    | 134,467         | 174,839      | **CustomLinkedHashSet**        | 1.30x  |
| `toString()`                      | 877,125         | 911,203      | Tie (Statistically Equivalent) | 1.04x  |

| Method                            | Overall Trend (Geomean)   | Small-Scale Tier (≤100)   | Large-Scale Tier (≥10k)   |
|:----------------------------------|:--------------------------|:--------------------------|:--------------------------|
