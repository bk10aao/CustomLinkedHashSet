#!/usr/bin/env python3
"""
Generate a performance comparison matrix heatmap between CustomLinkedSet V2 and JDK LinkedHashSet.
...
# Load datasets
custom_df = load_wide_jmh_csv('V2_JDK/CustomLinkedSet_jmh_performanceV2.csv')   # Custom V2
...
for i, m in enumerate(methods):
    ...
    for j, size in enumerate(sizes):
        ...
        # log2 ratio: positive means Custom V2 is faster (JDK took more time)
...
ax.set_title(
    'CustomLinkedSet V2 vs JDK LinkedHashSet\n'
    'Performance Comparison Matrix Heatmap\n'
    '(Positive/Blue = Custom V2 Faster, Negative/Red = JDK Faster)',
...
plt.tight_layout()
plt.savefig('V2_JDK/heatmap.png', dpi=300, transparent=True)
plt.close()

print("Heatmap saved successfully as heatmap.png")
print("Top 3 worst performing methods for Custom V2 on average:")
print(display_methods[:3])
print("Top 3 best performing methods for Custom V2 on average:")
print(display_methods[-3:])